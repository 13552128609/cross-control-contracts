...
function parseScArgs() {
    ...
    let argv = optimist
        ...
        .describe('superAddr', `update deletegate contract and super user`)
        .describe('adminAddr', `adminAddr`)
        .describe('monitorAddr', `monitoryAddr`)
        ...
        .string(["network", "nodeURL", "address", "mnemonic", "ownerPk", "inputDir", "adminAddr", "monitorAddr","superAddr"])
        .demand(['network'])
        .argv;
